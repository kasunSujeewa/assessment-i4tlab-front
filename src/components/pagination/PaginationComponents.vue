...
const lastPage = computed(() => taskData.lastPage);
</script>

<template>
  <Pagination v-slot="{ page }" :total="total" :sibling-count="1" show-edges :default-page="currentPage" @pageChange="handlePageChange">
